...
from simder_planning import run_comparison, spherical_shell_task_b


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Compare planners on simDER spherical-shell Task B"
    )
    ...
    comparison = run_comparison(
        spherical_shell_task_b(arguments.seeds),
    ...
    print(f"Spherical-shell comparison results={arguments.output}")
