...
from simder_planning import planar_contact_release_task, run_comparison


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Compare planners on the simDER planar contact-release task"
    )
    ...
    comparison = run_comparison(
        planar_contact_release_task(arguments.seeds),
    ...
    print(f"Planar contact comparison results={arguments.output}")
